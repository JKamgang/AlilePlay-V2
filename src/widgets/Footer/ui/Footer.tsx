        ...
        <footer className="bg-gray-900 text-gray-400 text-sm mt-12 py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                    <div>
                        <h4 className="font-bold text-white mb-2">Alile Play, a product of Alile Group</h4>
                        <p>Lead Designer: Jean Baptiste</p>
                        <p>Contact: cs@alileva.com</p>
                    ...
                    <div>
                        ...
                        <p>This platform is provided "as is". Alile Group is not responsible for user interactions. By using this service, you agree to our Terms of Use. Violation may result in account termination. Liability is limited to the amount invested by the user.</p>
                    </div>
                     <div>
                ...
                <div className="mt-8 pt-8 border-t border-gray-800 text-center">
                    <p>&copy; {new Date().getFullYear()} Alile Group. All rights reserved. Platform design and concept by Jean Baptiste.</p>
                </div>
            </div>
        </footer>
    );
